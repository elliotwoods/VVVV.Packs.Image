...
//namespace VVVV.Nodes.OpenCV.uEye
//{
//	#region PluginInfo
//	[PluginInfo(Name = "CaptureProperty", Category = "CV.Image", Version = "uEye", Help = "Set properties for uEye camera", Tags = "", Author = "elliotwoods", AutoEvaluate = true)]
