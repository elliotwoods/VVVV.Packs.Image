...
{
	#region PluginInfo
	[PluginInfo(Name = "CaptureProperty", Category = "OpenCV", Version = "DirectShow", Help = "Set properties for DirectShow video", Tags = "", Author="Elliot Woods", AutoEvaluate = true)]
